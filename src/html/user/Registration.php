            ...
            <div class="login-square" id="register-sq">
                <form id="form-r" method="post">
                    <div class="row">
                        ...
                        <input type="email" id="email" name="nw-em" class="form-style" value="<?= htmlspecialchars($userEmail) ?>">
                    </div>
                    <div class="row">
                        <label for="username" class="form-label-reg">Username</label>
                        <input type="text" id="username" name="nw-usr" class="form-style" value="<?= htmlspecialchars($userUsername) ?>">
                    </div>
                    <div class="row">
                        <label for="psd" class="form-label-reg">Password</label>
                        <input type="password" id="psd" name="nw-passwd" class="form-style" value="<?= htmlspecialchars($userPassword) ?>">
                    </div>
                    <div class="row">
                        <label for="dob" class="form-label-reg">Date Of Birth</label>
                        <input type="date" id="dob" name="day" class="form-style" min="1952-01-01" max="2023-01-01" value="<?= htmlspecialchars($userDate) ?>">
                    </div>
                    <div class="row">
